...
if __name__ == '__main__':
    ...
    parser.add_argument('--testing_flag', type=bool, required = False, default = False,
        help = 'flag for whether or not you want to test with custom examples')
    parser.add_argument('--test_file', type = str, default = None,
        help = 'name of the file with the custom test case')
